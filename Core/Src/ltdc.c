...
/* USER CODE BEGIN 0 */
#define LTDC_BUF_SIZE   130560
uint16_t LTDC_BUFF[LTDC_BUF_SIZE]={0};
...
void MX_LTDC_Init(void)
{
  ...
  hltdc.Init.VerticalSync = 36;
  hltdc.Init.AccumulatedHBP = 117;
  hltdc.Init.AccumulatedVBP = 48;
  hltdc.Init.AccumulatedActiveW = 597;
  hltdc.Init.AccumulatedActiveH = 320;
  hltdc.Init.TotalWidth = 672;
  hltdc.Init.TotalHeigh = 357;
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_0|GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_8
                          |GPIO_PIN_9);
